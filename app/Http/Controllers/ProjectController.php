    ...
    public function getJenayahData(Project $project)
    {
        ...
        return DataTables::of($query)
            ...
            ->rawColumns([
                ...
                'status_permohonan_laporan_pakar_judi',
                'status_laporan_penuh_pakar_judi',
                'keputusan_laporan_pakar_judi',
                ...
                'permohonan_laporan_pengesahan_masuk_keluar_malaysia',
        ...
        return DataTables::of($query)
            ...
            ->rawColumns(array_merge(
                [
                    ...
                    'status_permohonan_E_FSA_1_oleh_IO_AIO',
                    'status_laporan_penuh_E_FSA_1_oleh_IO_AIO',
                    'status_permohonan_E_FSA_2_oleh_IO_AIO',
                    'status_laporan_penuh_E_FSA_2_oleh_IO_AIO',
                    'status_permohonan_E_FSA_3_oleh_IO_AIO',
                    'status_laporan_penuh_E_FSA_3_oleh_IO_AIO',
                    'status_permohonan_E_FSA_4_oleh_IO_AIO',
                    'status_laporan_penuh_E_FSA_4_oleh_IO_AIO',
                    'status_permohonan_E_FSA_5_oleh_IO_AIO',
                    'status_laporan_penuh_E_FSA_5_oleh_IO_AIO',
                    'status_permohonan_E_FSA_1_telco_oleh_IO_AIO',
                    'status_laporan_penuh_E_FSA_1_telco_oleh_IO_AIO',
                    'status_permohonan_E_FSA_2_telco_oleh_IO_AIO',
                    'status_laporan_penuh_E_FSA_2_telco_oleh_IO_AIO',
                    'status_permohonan_E_FSA_3_telco_oleh_IO_AIO',
                    'status_laporan_penuh_E_FSA_3_telco_oleh_IO_AIO',
                    'status_permohonan_E_FSA_4_telco_oleh_IO_AIO',
                    'status_laporan_penuh_E_FSA_4_telco_oleh_IO_AIO',
                    'status_permohonan_E_FSA_5_telco_oleh_IO_AIO',
                    'status_laporan_penuh_E_FSA_5_telco_oleh_IO_AIO',
    ...
    public function getNarkotikData(Project $project)
    {
        ...
        return DataTables::of($query)
            ...
            ->editColumn('tarikh_semboyan_pertama_wanted_person', function ($row) {
                return ($row->status_semboyan_pertama_wanted_person === 'Tiada / Tidak Cipta')
                    ? '-' : (optional($row->tarikh_semboyan_pertama_wanted_person)->format('d/m/Y') ?? '-');
            })
            ->editColumn('tarikh_semboyan_kedua_wanted_person', function ($row) {
                return ($row->status_semboyan_kedua_wanted_person === 'Tiada / Tidak Cipta')
                    ? '-' : (optional($row->tarikh_semboyan_kedua_wanted_person)->format('d/m/Y') ?? '-');
            })
            ->editColumn('tarikh_semboyan_ketiga_wanted_person', function ($row) {
                return ($row->status_semboyan_ketiga_wanted_person === 'Tiada / Tidak Cipta')
                    ? '-' : (optional($row->tarikh_semboyan_ketiga_wanted_person)->format('d/m/Y') ?? '-');
            })
    ...
    public function getLaporanMatiMengejutData(Project $project)
    {
        ...
        return DataTables::of($query)
            ...
            ->rawColumns([
                ...
                'status_pem',
                'keputusan_akhir_mahkamah',
                'adakah_ms_2_lmm_telah_disahkan_oleh_kpd',
                'adakah_lmm_telah_di_rujuk_kepada_ya_koroner',
                'arahan_minit_oleh_sio_status',
                'arahan_minit_ketua_bahagian_status',
                'arahan_minit_ketua_jabatan_status',
                'arahan_minit_oleh_ya_tpr_status',
                ...
                'status_laporan_penuh_imigresen',
                'permohonan_laporan_pengesahan_masuk_keluar_malaysia',
                'permohonan_laporan_permit_kerja_di_malaysia',
                'permohonan_laporan_agensi_pekerjaan_di_malaysia',
                'permohonan_status_kewarganegaraan',

...
class OrangHilangPaper extends Model
{
    ...
    protected $casts = [
        'project_id' => 'integer',
        'tarikh_ks_oh_dibuka' => 'date:Y-m-d',
        'tarikh_laporan_polis_header' => 'date:Y-m-d', // Renamed as 'seksyen_dibuka' seems missing
        'tarikh_minit_a' => 'date:Y-m-d', // Mapped from "TARIKH EDARAN MINIT PERTAMA"
        'tarikh_minit_b' => 'date:Y-m-d', // Likely null
        'tarikh_minit_c' => 'date:Y-m-d', // Likely null
    ...
    public $sortable = [
        'id', 'no_ks_oh', 'tarikh_ks_oh_dibuka', 'status_ks_oh', 'status_kes', 'pegawai_pemeriksa_jips', 'io_aio', 'created_at', 'updated_at'
        // Add other sortable columns specific to Orang Hilang
    ];
    ...
    {
        // For Orang Hilang, tarikh_minit_b might be null
    ...
    public function calculateBaruKemaskiniClientLogic() // THIS IS AN INTERPRETATION
    {
        ...
        // For Orang Hilang, tarikh_minit_c will likely be null

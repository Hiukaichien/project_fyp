...
class LaporanMatiMengejutPaper extends Model
{
    ...
    public $sortable = [
        'id', 'no_lmm', 'tarikh_lmm_dibuka', 'status_lmm', 'status_kes', 'pegawai_pemeriksa_jips', 'io_aio', 'created_at', 'updated_at'
        // Add other sortable columns specific to LMM
    ];
    ...
    {
        // For LMM, tarikh_minit_b might be null
    ...
    public function calculateBaruKemaskiniClientLogic() // THIS IS AN INTERPRETATION
    {
        ...
        // For LMM, tarikh_minit_c will likely be null

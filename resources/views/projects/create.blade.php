        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    @if ($errors->any())
                        <div class="mb-4">
                            <div class="font-medium text-red-600 dark:text-red-400">{{ __('Aduh! Ada masalah berlaku.') }}</div>
                    ...
                    <form method="POST" action="{{ route('projects.store') }}">
                        ...
                        <!-- Project Name -->
                        <div class="mb-4">
                            <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('Nama Projek') }}</label>
                        ...
                        <!-- Project Date -->
                        <div class="mb-4">
                            <label for="project_date" class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('Tarikh Projek') }}</label>
                        ...
                        <!-- Description -->
                        <div class="mb-6">
                            <label for="description" class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('Penerangan (Pilihan)') }}</label>

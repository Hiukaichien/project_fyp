    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div>
                ...
                <a href="{{ route('kertas_siasatan.edit', ['paperType' => class_basename($paper), 'id' => $paper->id]) }}" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded text-sm">
                    Audit / Kemaskini
                </a>
            </div>
        </div>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                <div class="px-4 py-5 sm:px-6"><h3 class="text-lg leading-6 font-medium text-gray-900">Maklumat Rujukan</h3></div>

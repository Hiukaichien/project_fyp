        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('kertas_siasatan.update', ['paperType' => 'NarkotikPaper', 'id' => $paper->id]) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 p-3 bg-gray-50 rounded border">
                    ...
                    <div><span class="font-semibold">Peg. Penyiasat:</span> {{ $paper->io_aio }}</div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                    <div>
                        ...
                        <input type="date" id="tarikh_minit_a" name="tarikh_minit_a" value="{{ old('tarikh_minit_a', optional($paper->tarikh_minit_a)->format('Y-m-d')) }}" class="mt-1 block w-full form-input">
                    </div>
                    <div>
                        <label for="tarikh_minit_d" class="block text-sm font-medium text-gray-700">Tarikh Edaran Akhir</label>
                        <input type="date" id="tarikh_minit_d" name="tarikh_minit_d" value="{{ old('tarikh_minit_d', optional($paper->tarikh_minit_d)->format('Y-m-d')) }}" class="mt-1 block w-full form-input">
                    </div>
                </div>
                <hr>

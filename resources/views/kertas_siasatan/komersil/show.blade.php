                ...
                <div class="border-t border-gray-200">
                    <dl class="sm:divide-y sm:divide-gray-200">
                        <div class="py-3 sm:py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-sm font-bold text-gray-900 sm:mt-0 sm:col-span-2">{{ $paper->lewat_edaran_48_jam_status_text ?? 'Tidak Terkira' }}</dd>
                        </div>
                        <div class="py-3 sm:py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            <dt class="text-sm font-medium text-yellow-800">Status Terbengkalai (>3 Bulan)</dt>
                            <dd class="mt-1 text-sm font-bold text-gray-900 sm:mt-0 sm:col-span-2">{{ $paper->terbengkalai_status_text ?? 'Tidak Terkira' }}</dd>
                        </div>
                        <div class="py-3 sm:py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            <dt class="text-sm font-medium text-yellow-800">Status Kemaskini</dt>
                            <dd class="mt-1 text-sm font-bold text-gray-900 sm:mt-0 sm:col-span-2">{{ $paper->baru_dikemaskini_status_text ?? 'Tidak Terkira' }}</dd>
                        </div>
                    </dl>
                </div>
            </div>
                ...
                <div class="border-t border-gray-200">
                    <dl class="sm:divide-y sm:divide-gray-200">
                        ...
                        <div class="py-3 sm:py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{!! show_json_list($paper->adakah_arahan_tuduh_oleh_ya_tpr_diambil_tindakan) !!}</dd>
                        </div>
                        <div class="py-3 sm:py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                <div class="border-t border-gray-200">
                    <dl class="sm:divide-y sm:divide-gray-200">
                        ...
                        <div class="py-3 sm:py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{!! show_json_list($paper->status_pergerakan_barang_kes) !!}</dd>
                        </div>
                        @if($paper->status_pergerakan_barang_kes_lain)
                        <div class="py-3 sm:py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 bg-yellow-50">
                            <dt class="text-sm font-medium text-gray-500">Status Pergerakan - Lain-lain</dt>
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $paper->status_pergerakan_barang_kes_lain }}</dd>
                        </div>
                        @endif
                        <div class="py-3 sm:py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            <dt class="text-sm font-medium text-gray-500">Status Barang Kes Selesai Siasatan</dt>
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{!! show_json_list($paper->status_barang_kes_selesai_siasatan) !!}</dd>
                        </div>
                        @if($paper->status_barang_kes_selesai_siasatan_lain)
                        <div class="py-3 sm:py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 bg-yellow-50">
                            <dt class="text-sm font-medium text-gray-500">Status Selesai Siasatan - Lain-lain</dt>
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $paper->status_barang_kes_selesai_siasatan_lain }}</dd>
                        </div>
                        @endif
                        <div class="py-3 sm:py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            <dt class="text-sm font-medium text-gray-500">Kaedah Pelupusan Dilaksanakan</dt>
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{!! show_json_list($paper->barang_kes_dilupusan_bagaimana_kaedah_pelupusan_dilaksanakan) !!}</dd>
                        </div>
                        @if($paper->barang_kes_dilupusan_bagaimana_kaedah_pelupusan_dilaksanakan_lain)
                        <div class="py-3 sm:py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 bg-yellow-50">
                            <dt class="text-sm font-medium text-gray-500">Kaedah Pelupusan - Lain-lain</dt>
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $paper->barang_kes_dilupusan_bagaimana_kaedah_pelupusan_dilaksanakan_lain }}</dd>
                        </div>
                        @endif
                        <div class="py-3 sm:py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            <dt class="text-sm font-medium text-gray-500">Pelupusan Barang Kes Wang Tunai ke Perbendaharaan</dt>
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{!! show_json_list($paper->adakah_pelupusan_barang_kes_wang_tunai_ke_perbendaharaan) !!}</dd>
                        </div>
                        <div class="py-3 sm:py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            <dt class="text-sm font-medium text-gray-500">Resit KEW.38E Pelupusan Wang Tunai</dt>
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{!! show_json_list($paper->resit_kew_38e_bagi_pelupusan) !!}</dd>
                        </div>
                        <div class="py-3 sm:py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            <dt class="text-sm font-medium text-gray-500">Borang Serah/Terima Pegawai Tangkapan</dt>
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{!! show_json_list($paper->adakah_borang_serah_terima_pegawai_tangkapan) !!}</dd>
                        </div>
                        <div class="py-3 sm:py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dl class="sm:divide-y sm:divide-gray-200">
                        ...
                        <div class="py-3 sm:py-4 sm:px-6 {{ $i % 2 == 0 ? 'bg-gray-50' : '' }}">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <dd class="text-sm text-gray-900">{!! show_boolean_badge($paper->{"status_permohonan_E_FSA_{$i}_oleh_IO_AIO"}, 'Dibuat', 'Tidak') !!}</dd>
                                    @if($paper->{"nama_bank_permohonan_E_FSA_{$i}BANK"} ?? $paper->{"nama_bank_permohonan_E_FSA_{$i}"})
                                        <div class="text-xs text-gray-600 mt-1">Bank: {{ $paper->{"nama_bank_permohonan_E_FSA_{$i}BANK"} ?? $paper->{"nama_bank_permohonan_E_FSA_{$i}"} }}</div>
                                    @endif
                                </div>
                                <div>
                                    <dt class="text-sm font-medium text-gray-500 mb-1">Laporan Penuh Diterima</dt>
                                    <dd class="text-sm text-gray-900">{!! show_status_and_date($paper->{"status_laporan_penuh_E_FSA_{$i}_oleh_IO_AIO"}, $paper->{"tarikh_laporan_penuh_E_FSA_{$i}_oleh_IO_AIO"}, 'Diterima', 'Tidak') !!}</dd>
                                    @if($paper->{"nama_bank_laporan_E_FSA_{$i}_oleh_IO_AIO"})
                                        <div class="text-xs text-gray-600 mt-1">Bank: {{ $paper->{"nama_bank_laporan_E_FSA_{$i}_oleh_IO_AIO"} }}</div>
                                    @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="py-3 sm:py-4 sm:px-6 {{ $i % 2 == 1 ? 'bg-gray-50' : '' }}">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <dt class="text-sm font-medium text-gray-500 mb-1">Permohonan</dt>
                                    <dd class="text-sm text-gray-900">{!! show_boolean_badge($paper->{"status_permohonan_E_FSA_{$i}_telco_oleh_IO_AIO"}, 'Dibuat', 'Tidak') !!}</dd>
                                    @if($paper->{"nama_telco_permohonan_E_FSA_{$i}_oleh_IO_AIO"})
                                        <div class="text-xs text-gray-600 mt-1">Telco: {{ $paper->{"nama_telco_permohonan_E_FSA_{$i}_oleh_IO_AIO"} }}</div>
                                    @endif
                                </div>
                                <div>
                                    <dt class="text-sm font-medium text-gray-500 mb-1">Laporan Penuh Diterima</dt>
                                    <dd class="text-sm text-gray-900">{!! show_status_and_date($paper->{"status_laporan_penuh_E_FSA_{$i}_telco_oleh_IO_AIO"}, $paper->{"tarikh_laporan_penuh_E_FSA_{$i}_telco_oleh_IO_AIO"}, 'Diterima', 'Tidak') !!}</dd>
                                    @if($paper->{"nama_telco_laporan_E_FSA_{$i}_oleh_IO_AIO"})
                                        <div class="text-xs text-gray-600 mt-1">Telco: {{ $paper->{"nama_telco_laporan_E_FSA_{$i}_oleh_IO_AIO"} }}</div>
                                    @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="py-3 sm:py-4 sm:px-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <dt class="text-sm font-medium text-gray-500 mb-1">Permohonan Laporan</dt>
                                    <dd class="text-sm text-gray-900">{!! show_status_and_date($paper->status_permohonan_laporan_jkr, $paper->tarikh_permohonan_laporan_jkr, 'Dibuat', 'Tidak') !!}</dd>
                                </div>
                                <div>
                                    <dt class="text-sm font-medium text-gray-500 mb-1">Laporan Penuh Diterima</dt>
                                    <dd class="text-sm text-gray-900">{!! show_status_and_date($paper->status_laporan_penuh_jkr, $paper->tarikh_laporan_penuh_jkr, 'Diterima', 'Tidak') !!}</dd>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="py-3 sm:py-4 sm:px-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="col-span-full">
                                    ...
                                    <dd class="text-sm text-gray-900">{{ $paper->jenis_barang_kes_forensik ?? '-' }}</dd>
                                </div>
                            </div>
                        </div>

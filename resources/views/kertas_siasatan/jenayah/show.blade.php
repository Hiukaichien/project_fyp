    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div>
                ...
                <a href="{{ route('kertas_siasatan.edit', ['paperType' => 'JenayahPaper', 'id' => $paper->id]) }}" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded text-sm">
                    Audit / Kemaskini
                </a>
            </div>
        </div>

    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('kertas_siasatan.update', ['paperType' => 'TrafikSeksyen', 'id' => $paper->id]) }}" class="space-y-10 bg-white p-8 shadow-lg rounded-lg">
                ...
                {{-- IPRS Standard Section - Read Only --}}
                ...
                function render_status_with_date_radio($id, $statusName, $dateName, $currentStatus, $currentDate, $YaLabel = 'Ada / Cipta', $TidakLabel = 'Tiada / Tidak Cipta', $showTidakBerkaitan = false) {
                    ...
                    if ($effectiveStatus === $YaLabel) {
                        $initialStatusForAlpine = $YaLabel;
                    } elseif ($effectiveStatus === 'Tidak Berkaitan') {
                        $initialStatusForAlpine = 'Tidak Berkaitan';
                    } else {
                        $initialStatusForAlpine = $TidakLabel;
                    }
                    
                    $html = "<div x-data='{ status: \"{$initialStatusForAlpine}\" }'>";
                    $html .= "<div class='mt-2 flex items-center space-x-6 flex-wrap'>";
                    $html .= "<label class='flex items-center cursor-pointer'><input type='radio' name='{$statusName}' value='{$YaLabel}' x-model='status' class='form-radio h-4 w-4 text-indigo-600'><span class='ml-2 text-gray-700'>{$YaLabel}</span></label>";
                    $html .= "<label class='flex items-center cursor-pointer'><input type='radio' name='{$statusName}' value='{$TidakLabel}' x-model='status' class='form-radio h-4 w-4 text-indigo-600'><span class='ml-2 text-gray-700'>{$TidakLabel}</span></label>";
                    
                    if ($showTidakBerkaitan) {
                        $html .= "<label class='flex items-center cursor-pointer'><input type='radio' name='{$statusName}' value='Tidak Berkaitan' x-model='status' class='form-radio h-4 w-4 text-indigo-600'><span class='ml-2 text-gray-700'>Tidak Berkaitan</span></label>";
                    }
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div>
                            <label for="no_lmm_t" class="block text-sm font-medium text-gray-700">No.L.M.M (T)</label>
                            <input type="text" name="no_lmm_t" id="no_lmm_t" value="{{ old('no_lmm_t', $paper->no_lmm_t) }}" class="mt-1 block w-full form-input">
                        </div>
                        <div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Adakah M/S 2 L.M.M(T) Telah Disahkan Oleh KPD</label>
                            {!! render_boolean_radio('adakah_ms2_lmm_t_disahkan_oleh_kpd', $paper->adakah_ms2_lmm_t_disahkan_oleh_kpd, 'Ya', 'Tidak') !!}
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Adakah L.M.M(T) Telah Di Rujuk Kepada YA Koroner Setelah Ada Arahan Oleh YA TPR</label>
                            {!! render_boolean_radio('adakah_lmm_t_dirujuk_kepada_ya_koroner', $paper->adakah_lmm_t_dirujuk_kepada_ya_koroner, 'Ya', 'Tidak') !!}
                        </div>
                        
                        <div>
                            <label for="keputusan_ya_koroner_lmm_t" class="block text-sm font-medium text-gray-700">Keputusan YA Koroner (L.M.M T)</label>
                            <textarea name="keputusan_ya_koroner_lmm_t" id="keputusan_ya_koroner_lmm_t" rows="3" class="mt-1 block w-full form-textarea" placeholder="">{{ old('keputusan_ya_koroner_lmm_t', $paper->keputusan_ya_koroner_lmm_t) }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {{-- Input fields for No. Daftar Barang Kes --}}
                            <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {{-- Input fields for Jenis Barang Kes --}}
                            <div>
                            ...
                            <div class="space-y-2 pl-4">
                                ...
                                <div class="flex items-start">
                                    <label class="flex items-center mt-2">
                                        <input type="radio" name="status_pergerakan_barang_kes" value="Ujian Makmal" id="radio_pergerakan_makmal_trafik" {{ $currentPergerakan == 'Ujian Makmal' ? 'checked' : '' }} class="form-radio h-4 w-4 text-blue-600">
                                        <span class="ml-2 text-gray-700">Ujian Makmal (Nyatakan):</span>
                                    </label>
                                    <input type="text" name="status_pergerakan_barang_kes_makmal" id="pergerakan_makmal_trafik" value="{{ old('status_pergerakan_barang_kes_makmal', $paper->status_pergerakan_barang_kes_makmal) }}" class="ml-2 form-input text-sm w-64" {{ $currentPergerakan != 'Ujian Makmal' ? 'disabled' : '' }}>
                                </div>
                                ...
                                <div class="flex items-center">
                                    <label class="flex items-center">
                                        <input type="radio" name="status_pergerakan_barang_kes" value="Lain-Lain" id="pergerakan_lain_trafik" {{ $currentPergerakan == 'Lain-Lain' ? 'checked' : '' }} class="form-radio h-4 w-4 text-blue-600">
                                        <span class="ml-2 text-gray-700">Lain-lain:</span>
                                    </label>
                                    <input type="text" name="status_pergerakan_barang_kes_lain" id="status_pergerakan_barang_kes_lain_trafik" value="{{ old('status_pergerakan_barang_kes_lain', $paper->status_pergerakan_barang_kes_lain) }}" class="ml-2 form-input text-sm w-64" {{ $currentPergerakan != 'Lain-Lain' ? 'disabled' : '' }}>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="space-y-2 pl-4">
                                ...
                                <div class="flex items-start">
                                    <label class="flex items-center mt-2">
                                        <input type="radio" name="status_barang_kes_selesai_siasatan" value="Dilupuskan ke Perbendaharaan" id="radio_selesai_siasatan_RM_trafik" {{ $currentSelesai == 'Dilupuskan ke Perbendaharaan' ? 'checked' : '' }} class="form-radio h-4 w-4 text-blue-600">
                                        <span class="ml-2 text-gray-700">Dilupuskan ke Perbendaharaan</span>
                                    </label>
                                    <input type="text" name="status_barang_kes_selesai_siasatan_RM" id="selesai_siasatan_RM_trafik" value="{{ old('status_barang_kes_selesai_siasatan_RM', $paper->status_barang_kes_selesai_siasatan_RM) }}" class="ml-2 form-input text-sm w-64" placeholder="RM" {{ $currentSelesai != 'Dilupuskan ke Perbendaharaan' ? 'disabled' : '' }}>
                                </div>
                                ...
                                <div class="flex items-center">
                                    <label class="flex items-center">
                                        <input type="radio" name="status_barang_kes_selesai_siasatan" value="Lain-Lain" id="selesai_lain_trafik" {{ $currentSelesai == 'Lain-Lain' ? 'checked' : '' }} class="form-radio h-4 w-4 text-blue-600">
                                        <span class="ml-2 text-gray-700">Lain-lain:</span>
                                    </label>
                                    <input type="text" name="status_barang_kes_selesai_siasatan_lain" id="status_barang_kes_selesai_siasatan_lain_trafik" value="{{ old('status_barang_kes_selesai_siasatan_lain', $paper->status_barang_kes_selesai_siasatan_lain) }}" class="ml-2 form-input text-sm w-64" {{ $currentSelesai != 'Lain-Lain' ? 'disabled' : '' }}>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="space-y-2 pl-4">
                                ...
                                <div class="flex items-center">
                                    <label class="flex items-center">
                                        <input type="radio" name="barang_kes_dilupusan_bagaimana_kaedah_pelupusan_dilaksanakan" value="Lain-Lain" {{ $currentKaedah == 'Lain-Lain' ? 'checked' : '' }} class="form-radio h-4 w-4 text-blue-600" id="kaedah_lain_trafik">
                                        <span class="ml-2 text-gray-700">Lain-lain</span>
                                    </label>
                                    <input type="text" name="kaedah_pelupusan_barang_kes_lain" id="kaedah_pelupusan_barang_kes_lain_trafik" value="{{ old('kaedah_pelupusan_barang_kes_lain', $paper->kaedah_pelupusan_barang_kes_lain) }}" class="ml-2 form-input text-sm w-64" {{ $currentKaedah != 'Lain-Lain' ? 'disabled' : '' }}>
                                </div>
                            </div>
                        </div>
                ...
                <div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            @php
                                $saman257Status = old('status_saman_pdrm_s_257', $paper->status_saman_pdrm_s_257) ?? '0';
                                $saman167Status = old('status_saman_pdrm_s_167', $paper->status_saman_pdrm_s_167) ?? '0';
                            @endphp
                            <div x-data='{ status: "{{ $saman257Status }}" }'>
                                <label class="block text-sm font-medium text-gray-700">Saman PDRM (S) 257 Adakah Dicipta</label>
                                <div class="mt-2 flex items-center space-x-6">
                                    <label class="flex items-center cursor-pointer"><input type="radio" name="status_saman_pdrm_s_257" value="1" x-model="status" class="form-radio h-4 w-4 text-indigo-600"><span class="ml-2">Ada Dicipta</span></label>
                                    <label class="flex items-center cursor-pointer"><input type="radio" name="status_saman_pdrm_s_257" value="0" x-model="status" class="form-radio h-4 w-4 text-indigo-600"><span class="ml-2">Tidak Dicipta</span></label>
                                </div>
                            ...
                            <div x-data='{ status: "{{ $saman167Status }}" }'>
                                <label class="block text-sm font-medium text-gray-700">Saman PDRM (S) 167 Adakah Dicipta</label>
                                <div class="mt-2 flex items-center space-x-6">
                                    <label class="flex items-center cursor-pointer"><input type="radio" name="status_saman_pdrm_s_167" value="1" x-model="status" class="form-radio h-4 w-4 text-indigo-600"><span class="ml-2">Ada Dicipta</span></label>
                                    <label class="flex items-center cursor-pointer"><input type="radio" name="status_saman_pdrm_s_167" value="0" x-model="status" class="form-radio h-4 w-4 text-indigo-600"><span class="ml-2">Tidak Dicipta</span></label>
                                </div>
                                <div x-show="status === '1'" x-transition class="mt-2">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Semboyan Pemakluman Ketiga Wanted Person Ke Daerah Untuk Kesan</label>
                                {!! render_status_with_date_radio('wp3', 'status_semboyan_ketiga_wanted_person', 'tarikh_semboyan_ketiga_wanted_person', $paper->status_semboyan_ketiga_wanted_person, $paper->tarikh_semboyan_ketiga_wanted_person, 'Ada / Cipta', 'Tiada / Tidak Cipta', true) !!}
                            </div>
                        </div>
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="p-4 border rounded-md">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Permohonan Laporan</label>
                                    {!! render_status_with_date_radio('jkr_permohonan', 'status_permohonan_laporan_jkr', 'tarikh_permohonan_laporan_jkr', $paper->status_permohonan_laporan_jkr, $paper->tarikh_permohonan_laporan_jkr, 'Dibuat', 'Tidak') !!}
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Laporan Penuh</label>
                                    {!! render_status_with_date_radio('jkr_penuh', 'status_laporan_penuh_jkr', 'tarikh_laporan_penuh_jkr', $paper->status_laporan_penuh_jkr, $paper->tarikh_laporan_penuh_jkr, 'Diterima', 'Tidak') !!}
                                </div>
                            </div>
                        </div>
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    setupOtherInputToggle('status_pergerakan_barang_kes', 'status_pergerakan_barang_kes_lain_trafik');

                    // Apply to Barang Kes "Status Selesai Siasatan"
                    setupOtherInputToggle('status_barang_kes_selesai_siasatan', 'status_barang_kes_selesai_siasatan_lain_trafik');
                    
                    // Apply to Barang Kes "Kaedah Pelupusan"
                    setupOtherInputToggle('barang_kes_dilupusan_bagaimana_kaedah_pelupusan_dilaksanakan', 'kaedah_pelupusan_barang_kes_lain_trafik');
                });
                </script>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // --- Initialize All Toggles for the Trafik Seksyen Form ---
    ...
    setupSpecialInputToggle(
        ...
        'radio_pergerakan_makmal_trafik',
        'pergerakan_makmal_trafik'
    );
    // Handles the "Lain-Lain" input in the same section
    setupSpecialInputToggle(
        'status_pergerakan_barang_kes',
        'pergerakan_lain_trafik',
        'status_pergerakan_barang_kes_lain_trafik'
    );
    ...
    setupSpecialInputToggle(
        ...
        'radio_selesai_siasatan_RM_trafik',
        'selesai_siasatan_RM_trafik'
    );
    // Handles the "Lain-Lain" input in the same section
    setupSpecialInputToggle(
        'status_barang_kes_selesai_siasatan',
        'selesai_lain_trafik',
        'status_barang_kes_selesai_siasatan_lain_trafik'
    );
